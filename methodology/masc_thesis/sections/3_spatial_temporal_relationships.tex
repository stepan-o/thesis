...
\begin{enumerate}
    ...
    \item Land use from DMTI Spatial by year (2001-2014)
...
\begin{itemize}
    ...
    \item Detailed land use from the Department of Geography was collected at a single point in time during summers of 2012 and 2013
\end{itemize}
...
Figure~\ref{fig:temporal_spans} presents temporal spans assigned to the data sources for joining with Teranet records.
...
These foreign keys indicate which Teranet records can be joining to a particular Census or TTS survey.
