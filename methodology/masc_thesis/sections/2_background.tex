...
Figure~\ref{fig:transportation_land_use} illustrates the complex interactions between land use and transportation system as summarized by Miller\cite{Miller2019}.

\begin{figure}[hbt!]
    \centering
    \begin{subfigure}[t]{.48\textwidth}
        \centering
        \includegraphics[width=\columnwidth,trim=4 4 4 4,clip]{urban_activity_transportation_system.png}
        \caption{The urban activity and transportation systems}
        \label{fig:urban_activity_tranportation_system}
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.
    %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[t]{.48\textwidth}
        \centering
        \includegraphics[width=\columnwidth,trim=4 4 4 4,clip]{long_run_short_run_transportation_interactions.png}
        \caption{Short-run activity / travel and long-run accessibility interactions between transportation and land use systems.}
        \label{fig:long_run_short_run_tranportation_in}
    \end{subfigure}
    \caption{Interactions between transportation and land development systems summarized by Miller\cite{Miller2019}.}
    \label{fig:transportation_land_use}
\end{figure}
...
\begin{figure}[hbt!]
    ...
    \caption{Chronological development of LUT models provided by Iacono\cite{Iacono2008}.}
...
It was based on theories of spatial interaction, such as the gravity model that was popular in quantitative geography and transportation planning at the time\cite{Bouchard1965}.


Models based on spatial interactions framework continued to be developed through mid-1980s, they became largely replaced with models grounded in random utility theory and econometric methods\cite{Iacono2008}.
