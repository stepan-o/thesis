...
%TODO rewrite to mention ILUTE
    ...
    To facilitate this study, data from various sources (Census, TTS, etc.) is required to be merged at the land parcel level to enhance datasets with additional attributes, while maintaining the ease of data storage and retrieval for analysis as needed.
